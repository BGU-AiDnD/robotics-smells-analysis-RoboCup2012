...
int RoleAttacker::S_count_shot_area_hold = 0;
...
*/
void
RoleAttacker::execute( rcsc::PlayerAgent * agent )
{
...
void
RoleAttacker::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleAttacker::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
int
RoleAttacker::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
bool
RoleAttacker::moveCentering( rcsc::PlayerAgent * agent )
{
  const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleAttacker::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleAttacker::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleAttacker::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleAttacker::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleAttacker::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleAttacker::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleAttacker::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleAttacker::doGoToPoint( PlayerAgent * agent,
