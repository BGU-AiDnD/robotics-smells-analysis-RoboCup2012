...
int RoleLAttacker::S_count_shot_area_hold = 0;
...
*/
void
RoleLAttacker::execute( rcsc::PlayerAgent * agent )
{
...
void
RoleLAttacker::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLAttacker::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
int
RoleLAttacker::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
bool
RoleLAttacker::moveCentering( rcsc::PlayerAgent * agent )
{
  const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleLAttacker::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleLAttacker::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLAttacker::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLAttacker::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLAttacker::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleLAttacker::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleLAttacker::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleLAttacker::doGoToPoint( PlayerAgent * agent,
