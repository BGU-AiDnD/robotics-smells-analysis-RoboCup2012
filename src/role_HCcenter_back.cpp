...
*/
void
RoleHCCenterBack::execute( PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCCenterBack::doKick( PlayerAgent * agent )
...
*/
void
RoleHCCenterBack::doMove( PlayerAgent * agent )
{double dash_power = 100.0;
...
*/
void
RoleHCCenterBack::doBasicMove( PlayerAgent * agent,
...
*/
Vector2D
RoleHCCenterBack::getBasicMoveTarget( PlayerAgent * agent,
                                    const Vector2D & home_pos,
                                    double * dist_thr )
{double dash_power = 100.0;
    const WorldModel & wm = agent->world();
...
*/
void
RoleHCCenterBack::doDefMidMove( PlayerAgent * agent,
                              const Vector2D & home_pos )
{
...
*/
Vector2D
RoleHCCenterBack::getDefMidMoveTarget( PlayerAgent * agent,
                                     const Vector2D & home_pos )
{double dash_power = 100.0;
    const WorldModel & wm = agent->world();
...
*/
void
RoleHCCenterBack::doCrossBlockAreaMove( PlayerAgent * agent,
                                      const Vector2D & home_pos )
{
...
*/
void
RoleHCCenterBack::doStopperMove( PlayerAgent * agent,
                               const Vector2D & home_pos )
{
    double dash_power = 100.0;
...
*/
void
RoleHCCenterBack::doDangerAreaMove( PlayerAgent * agent,
                                  const Vector2D & home_pos )
{double dash_power = 100.0;
...
void
RoleHCCenterBack::doMarkMove( PlayerAgent * agent,
                            const Vector2D & home_pos )
{double dash_power = 100.0;
    //-----------------------------------------------
    // tackle
...
*/
bool
RoleHCCenterBack::doDangerGetBall( PlayerAgent * agent,
                                 const Vector2D & home_pos )
{double dash_power = 100.0;
    //////////////////////////////////////////////////////////////////
    // tackle
...
*/
void
RoleHCCenterBack::doGoToPoint( PlayerAgent * agent,
