...
#ifndef GEAR_ROLE_HCCENTER_HALF_H
#define GEAR_ROLE_HCCENTER_HALF_H
...
public:
    ...
    ~RoleHCCenterHalf()
      {
          //std::cerr << "delete RoleHCCenterHalf" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCCenterHalf" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCCenterHalf() );
      }
