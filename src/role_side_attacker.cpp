...
int RoleSideAttacker::S_count_shot_area_hold = 0;
...
*/
void
RoleSideAttacker::execute( rcsc::PlayerAgent * agent )
{
...
void
RoleSideAttacker::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleSideAttacker::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
    ...
    if(wm.existKickableTeammate() && wm.self().pos().dist(wm.ball().pos()) < 20.0)      //if our team has ball possession
    {
        ...
        if(wm.existOpponentIn(clearArea,1,false)) {         //if there is an opponent
            ...
            double dash_power = rcsc::ServerParam::i().maxPower()*0.8;
...
int
RoleSideAttacker::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
bool
RoleSideAttacker::moveCentering( rcsc::PlayerAgent * agent )
{
  const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleSideAttacker::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleSideAttacker::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleSideAttacker::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleSideAttacker::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleSideAttacker::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleSideAttacker::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleSideAttacker::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleSideAttacker::doGoToPoint( rcsc::PlayerAgent * agent,
