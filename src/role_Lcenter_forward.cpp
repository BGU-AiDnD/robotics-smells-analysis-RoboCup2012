...
int RoleLCenterForward::S_count_shot_area_hold = 0;
...
*/
void
RoleLCenterForward::execute( rcsc::PlayerAgent* agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleLCenterForward::doKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLCenterForward::doMove( rcsc::PlayerAgent * agent )
{
    double dash_power = 33.0;
...
*/
bool
RoleLCenterForward::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleLCenterForward::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLCenterForward::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLCenterForward::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLCenterForward::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleLCenterForward::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleLCenterForward::doGoToPoint( rcsc::PlayerAgent * agent,
