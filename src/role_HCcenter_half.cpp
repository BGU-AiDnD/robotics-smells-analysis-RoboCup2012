...
int RoleHCCenterHalf::S_count_shot_area_hold = 0;
...
*/
void
RoleHCCenterHalf::execute( rcsc::PlayerAgent* agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCCenterHalf::doKick( rcsc::PlayerAgent* agent )
...
*/
void
RoleHCCenterHalf::doMove( rcsc::PlayerAgent * agent )
{double dash_power = 100.0;
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCCenterHalf::doCrossBlockMove( rcsc::PlayerAgent* agent,
...
*/
void
RoleHCCenterHalf::doOffensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
...
*/
void
RoleHCCenterHalf::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
...
*/
void
RoleHCCenterHalf::doDribbleBlockMove( rcsc::PlayerAgent* agent,
                                       const rcsc::Vector2D& home_pos )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCCenterHalf::doCrossAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::TEAM,
...
*/
void
RoleHCCenterHalf::doShootAreaKick( rcsc::PlayerAgent* agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
bool
RoleHCCenterHalf::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{double dash_power = 100.0;
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCCenterHalf::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
void RoleHCCenterHalf::doOffensiveMiddleKick( PlayerAgent * agent )
{double dash_power = 100.0;
    const rcsc::WorldModel & wm = agent->world();
