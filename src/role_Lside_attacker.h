...
#ifndef GEAR_ROLE_LSIDE_ATTACKER_H
#define GEAR_ROLE_LSIDE_ATTACKER_H
...
public:
    ...
    ~RoleLSideAttacker()
      {
          //std::cerr << "delete RoleLSideAttacker" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "LSideAttacker" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleLSideAttacker() );
      }
