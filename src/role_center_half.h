...
#ifndef GEAR_ROLE_CENTER_HALF_H
#define GEAR_ROLE_CENTER_HALF_H
...
public:
    ...
    ~RoleCenterHalf()
      {
          //std::cerr << "delete RoleCenterHalf" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "CenterHalf" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleCenterHalf() );
      }
