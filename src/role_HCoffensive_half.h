...
#ifndef GEAR_ROLE_HCOFFENSIVE_HALF_H
#define GEAR_ROLE_HCOFFENSIVE_HALF_H
...
public:
    ...
    ~RoleHCOffensiveHalf()
      {
          //std::cerr << "delete RoleHCOffensiveHalf" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCOffensiveHalf" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCOffensiveHalf() );
      }
