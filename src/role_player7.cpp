...
int RolePlayer7::S_count_shot_area_hold = 0;

//#define USE_BHV_DEFENSIVE_HALF_DANGER_MOVE
#define USE_BHV_DEFENSIVE_HALF_DEFENSIVE_MOVE

rcsc::Vector2D RolePlayer7::p7AP;

rcsc::Vector2D RolePlayer7::p7DP;

rcsc::Vector2D RolePlayer7::p7VAP;

rcsc::Vector2D RolePlayer7::p7VDP;

rcsc::Vector2D RolePlayer7::p7PB = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7PB5 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7PB6 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7PB8 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7PB9 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7PB10 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer7::p7LB = rcsc::Vector2D(-70.0,-70.0);
...
*/
void
RolePlayer7::execute( rcsc::PlayerAgent* agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RolePlayer7::doKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RolePlayer7::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
    ...
    case Strategy::BA_ShootChance:
        ...
        {
            rcsc::Vector2D target_point = p7AP;
        ...
        {
            rcsc::Vector2D target_point = p7DP;
            double dash_power = Strategy::get_set_play_dash_power( wm );
            doGoToPoint( agent, target_point, dist_thr, dash_power, 15.0 );
            //rcsc::Body_GoToPoint(target_point, dist_thr, dash_power, true);
            //rcsc::Body_GoToPointDodge(target_point, dash_power);
...
*/
void
RolePlayer7::doCrossBlockMove( rcsc::PlayerAgent* agent,
...
*/
void
RolePlayer7::doOffensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
void
RolePlayer7::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
void
RolePlayer7::doDribbleBlockMove( rcsc::PlayerAgent* agent,
                                       const rcsc::Vector2D& home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RolePlayer7::doCrossAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::TEAM,
...
*/
void
RolePlayer7::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
bool
RolePlayer7::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RolePlayer7::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
void RolePlayer7::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RolePlayer7::doGoToPoint( PlayerAgent * agent,
...
//#if 0
void
RolePlayer7::swarmUpdatePosition(PlayerAgent * agent)
{
    const WorldModel & wm = agent->world();
...
void
RolePlayer7::swarmAttack(PlayerAgent * agent)
{
    const WorldModel & wm = agent->world();
    ...
    {
        if(wm.teammate(5) != 0) p7PB5 = wm.teammate(5)->pos();

        if(wm.teammate(6) != 0) p7PB6 = wm.teammate(6)->pos();

        if(wm.teammate(7) != 0) p7PB = wm.teammate(7)->pos();

        if(wm.teammate(8) != 0) p7PB8 = wm.teammate(8)->pos();

        if(wm.teammate(9) != 0) p7PB9 = wm.teammate(9)->pos();

        if(wm.teammate(10) != 0) p7PB10 = wm.teammate(10)->pos();

        if(wm.teammate(10) != 0) p7LB = wm.teammate(10)->pos();

        p7VAP.x = wm.ball().pos().x - wm.self().pos().x;
        p7VDP.x = wm.ball().pos().x - wm.self().pos().x;

        p7AP = rcsc::Vector2D(-50.0,0.0);
        p7DP = rcsc::Vector2D(-50.0,0.0);
    ...
    else
    {
        ...
        if(p7PB5 != PB[0]) p7PB5 = PB[0];

        if (p7PB6 != PB[1]) p7PB6 = PB[1];

        if (p7PB != PB[2]) p7PB = PB[2];

        if (p7PB8 != PB[3]) p7PB8 = PB[3];

        if (p7PB9 != PB[4]) p7PB9 = PB[4];

        if (p7PB10 != PB[5]) p7PB10 = PB[5];
        ...
        p7AP = wm.self().pos() + speed;
        p7DP = wm.self().pos() + speed;

        p7VAP = p7AP;       //represents inertia
        p7VDP = p7DP;
    }
}
...
void
RolePlayer7::swarmDefense(PlayerAgent * agent)
{
    Swarm s;
}
//#endif
