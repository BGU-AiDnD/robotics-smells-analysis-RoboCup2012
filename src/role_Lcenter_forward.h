...
#ifndef GEAR_ROLE_LCENTER_FORWARD_H
#define GEAR_ROLE_LCENTER_FORWARD_H
...
public:
    ...
    ~RoleLCenterForward()
      {
          //std::cerr << "delete RoleLCenterForward" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "LCenterForward" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleLCenterForward() );
      }
