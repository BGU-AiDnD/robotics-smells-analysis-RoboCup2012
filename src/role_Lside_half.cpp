...
int RoleLSideHalf::S_count_shot_area_hold = 0;
...
*/
void
RoleLSideHalf::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleLSideHalf::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLSideHalf::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleLSideHalf::doDribbleAttackKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLSideHalf::doShootChanceKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLSideHalf::doOffensiveMove( rcsc::PlayerAgent * agent,
...
*/
void
RoleLSideHalf::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleLSideHalf::doShootAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
bool
RoleLSideHalf::doShootAreaIntercept( rcsc::PlayerAgent * agent,
                                         const rcsc::Vector2D & /*home_pos*/ )
{
    const rcsc::WorldModel & wm = agent->world();
    const int self_min = wm.interceptTable()->selfReachCycle();
...
int
RoleLSideHalf::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
*/
void
RoleLSideHalf::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
bool
RoleLSideHalf::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleLSideHalf::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleLSideHalf::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLSideHalf::doDribbleAttackAreaKick( rcsc::PlayerAgent* agent )
{
    // !!!check stamina!!!
    static bool S_recover_mode = false;
...
*/
bool
RoleLSideHalf::doStraightDribble( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleLSideHalf::doSideForwardDribble( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
rcsc::Vector2D
RoleLSideHalf::getDribbleTarget( rcsc::PlayerAgent * agent )
{
...
*/
int
RoleLSideHalf::getDribbleAttackDashStep( const rcsc::PlayerAgent * agent,
...
bool
RoleLSideHalf::kickCentering( rcsc::PlayerAgent * agent )
{
  //センタリング 090704
  const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleLSideHalf::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
