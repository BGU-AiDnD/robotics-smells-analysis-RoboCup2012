...
#ifndef GEAR_ROLE_LDEFENSIVE_HALF_H
#define GEAR_ROLE_LDEFENSIVE_HALF_H
...
public:
    ...
    ~RoleLDefensiveHalf()
      {
          //std::cerr << "delete RoleLDefensiveHalf" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "LDefensiveHalf" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleLDefensiveHalf() );
      }
