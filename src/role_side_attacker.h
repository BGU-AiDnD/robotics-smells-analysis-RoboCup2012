...
#ifndef GEAR_ROLE_SIDE_ATTACKER_H
#define GEAR_ROLE_SIDE_ATTACKER_H
...
public:
    ...
    ~RoleSideAttacker()
      {
          //std::cerr << "delete RoleSideAttacker" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "SideAttacker" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleSideAttacker() );
      }
