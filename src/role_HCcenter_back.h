...
#ifndef ROLE_HCCENTER_BACK_H
#define ROLE_HCCENTER_BACK_H
...
public:
    ...
    ~RoleHCCenterBack()
      {
          //std::cerr << "delete RoleHCCenterBack" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCCenterBack" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCCenterBack() );
      }
