...
*/
void
RoleHCSideForward::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCSideForward::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideForward::doMove( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideForward::doDribbleAttackAreaKick( rcsc::PlayerAgent* agent )
{
    // !!!check stamina!!!
...
*/
bool
RoleHCSideForward::doStraightDribble( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
    double dash_power = 100.0;
    // dribble straight
...
*/
void
RoleHCSideForward::doSideForwardDribble( rcsc::PlayerAgent * agent )
{
    double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
bool
RoleHCSideForward::doSelfPass( rcsc::PlayerAgent * agent,
...
*/
rcsc::Vector2D
RoleHCSideForward::getDribbleTarget( rcsc::PlayerAgent * agent )
{
...
*/
int
RoleHCSideForward::getDribbleAttackDashStep( const rcsc::PlayerAgent * agent,
...
*/
void
RoleHCSideForward::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{
    double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCSideForward::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCSideForward::doShootAreaKick( rcsc::PlayerAgent * agent )
{
    double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
double
RoleHCSideForward::getShootAreaMoveDashPower( rcsc::PlayerAgent * agent,
...
*/
rcsc::Vector2D
RoleHCSideForward::getShootAreaMoveTarget( rcsc::PlayerAgent * agent,
...
*/
void
RoleHCSideForward::doShootAreaMove( rcsc::PlayerAgent* agent,
                                  const rcsc::Vector2D& home_pos )
{
    double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
void
RoleHCSideForward::doGoToPoint( rcsc::PlayerAgent * agent,
                             const rcsc::Vector2D & target_point,
