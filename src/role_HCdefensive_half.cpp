...
*/
void
RoleHCDefensiveHalf::execute( rcsc::PlayerAgent* agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCDefensiveHalf::doKick( rcsc::PlayerAgent* agent )
...
*/
void
RoleHCDefensiveHalf::doMove( rcsc::PlayerAgent * agent )
{double dash_power = 100.0;
...
*/
void
RoleHCDefensiveHalf::doCrossBlockMove( rcsc::PlayerAgent* agent,
...
*/
void
RoleHCDefensiveHalf::doOffensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
...
*/
void
RoleHCDefensiveHalf::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
...
*/
void
RoleHCDefensiveHalf::doDribbleBlockMove( rcsc::PlayerAgent* agent,
                                       const rcsc::Vector2D& home_pos )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCDefensiveHalf::doCrossAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::TEAM,
