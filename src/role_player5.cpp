...
rcsc::Vector2D RolePlayer5::p5AP;

rcsc::Vector2D RolePlayer5::p5DP;

rcsc::Vector2D RolePlayer5::p5VAP;

rcsc::Vector2D RolePlayer5::p5VDP;

rcsc::Vector2D RolePlayer5::p5PB = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer5::p5PB2 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer5::p5PB3 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer5::p5PB4 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer5::p5PB6 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer5::p5LB = rcsc::Vector2D(-70.0,-70.0);
...
*/
void
RolePlayer5::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RolePlayer5::doKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RolePlayer5::doMove( rcsc::PlayerAgent * agent )
{
    ...
    case Strategy::BA_ShootChance:
        ...
        {
            rcsc::Vector2D target_point = p5AP;
        ...
        {
            rcsc::Vector2D target_point = p5DP;
            double dash_power = Strategy::get_set_play_dash_power( wm );
            doGoToPoint( agent, target_point, dist_thr, dash_power, 15.0 );
            //rcsc::Body_GoToPoint(target_point, dist_thr, dash_power, true);
            //rcsc::Body_GoToPointDodge(target_point, dash_power);
...
*/
void
RolePlayer5::doBasicMove( rcsc::PlayerAgent * agent,
...
*/
rcsc::Vector2D
RolePlayer5::getBasicMoveTarget( rcsc::PlayerAgent * agent,
                                  const rcsc::Vector2D & home_pos )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RolePlayer5::doBlockPassLine( rcsc::PlayerAgent * agent,
                               const rcsc::Vector2D & home_pos )
{
...
*/
void
RolePlayer5::doCrossBlockAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RolePlayer5::doDangerAreaMove( rcsc::PlayerAgent * agent,
                                const rcsc::Vector2D & home_pos )
{
...
*/
void
RolePlayer5::doDribbleBlockAreaMove( rcsc::PlayerAgent * agent,
                                      const rcsc::Vector2D & home_pos )
{
...
*/
void
RolePlayer5::doDefMidAreaMove( rcsc::PlayerAgent * agent,
                                const rcsc::Vector2D & home_pos )
{
#ifdef USE_BHV_SIDE_BACK_DEFENSIVE_MOVE
    (void)home_pos;
...
*/
void
RolePlayer5::doBlockSideAttacker( rcsc::PlayerAgent * agent,
                                   const rcsc::Vector2D & home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RolePlayer5::doGoToPoint( PlayerAgent * agent,
...
//#if 0
void
RolePlayer5::swarmUpdatePosition(PlayerAgent * agent)
{
    const WorldModel & wm = agent->world();
...
void
RolePlayer5::swarmAttack(PlayerAgent * agent)
{
    const WorldModel & wm = agent->world();
    ...
    {
        if(wm.teammate(2) != 0) p5PB2 = wm.teammate(2)->pos();

        if(wm.teammate(3) != 0) p5PB3 = wm.teammate(3)->pos();

        if(wm.teammate(4) != 0) p5PB4 = wm.teammate(4)->pos();

        if(wm.teammate(5) != 0) p5PB = wm.teammate(5)->pos();

        if(wm.teammate(6) != 0) p5PB6 = wm.teammate(6)->pos();

        if(wm.teammate(6) != 0) p5LB = wm.teammate(6)->pos();

        p5VAP.x = wm.ball().pos().x - wm.self().pos().x;
        p5VDP.x = wm.ball().pos().x - wm.self().pos().x;

        p5AP = rcsc::Vector2D(-50.0,0.0);
        p5DP = rcsc::Vector2D(-50.0,0.0);
    ...
    else
    {
        ...
        if(p5PB2 != PB[0]) p5PB2 = PB[0];

        if (p5PB3 != PB[1]) p5PB3 = PB[1];

        if (p5PB4 != PB[2]) p5PB4 = PB[2];

        if (p5PB != PB[3]) p5PB = PB[3];

        if (p5PB6 != PB[4]) p5PB6 = PB[4];
        ...
        p5AP = wm.self().pos() + speed;
        p5DP = wm.self().pos() + speed;

        p5VAP = p5AP;       //represents inertia
        p5VDP = p5DP;
    }
}
...
void
RolePlayer5::swarmDefense(PlayerAgent * agent)
{
    Swarm s;
}
//#endif
