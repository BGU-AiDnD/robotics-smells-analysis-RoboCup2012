...
int RoleLSideAttacker::S_count_shot_area_hold = 0;
...
*/
void
RoleLSideAttacker::execute( rcsc::PlayerAgent * agent )
{
...
void
RoleLSideAttacker::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLSideAttacker::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
int
RoleLSideAttacker::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
bool
RoleLSideAttacker::moveCentering( rcsc::PlayerAgent * agent )
{
  const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleLSideAttacker::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleLSideAttacker::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLSideAttacker::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLSideAttacker::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLSideAttacker::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleLSideAttacker::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleLSideAttacker::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleLSideAttacker::doGoToPoint( PlayerAgent * agent,
