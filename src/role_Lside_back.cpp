...
*/
void
RoleLSideBack::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleLSideBack::doKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleLSideBack::doMove( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLSideBack::doBasicMove( rcsc::PlayerAgent * agent,
...
*/
rcsc::Vector2D
RoleLSideBack::getBasicMoveTarget( rcsc::PlayerAgent * agent,
                                  const rcsc::Vector2D & home_pos )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleLSideBack::doBlockPassLine( rcsc::PlayerAgent * agent,
                               const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleLSideBack::doCrossBlockAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLSideBack::doDangerAreaMove( rcsc::PlayerAgent * agent,
                                const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleLSideBack::doDribbleBlockAreaMove( rcsc::PlayerAgent * agent,
                                      const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleLSideBack::doDefMidAreaMove( rcsc::PlayerAgent * agent,
                                const rcsc::Vector2D & home_pos )
{
#ifdef USE_BHV_SIDE_BACK_DEFENSIVE_MOVE
    (void)home_pos;
...
*/
void
RoleLSideBack::doBlockSideAttacker( rcsc::PlayerAgent * agent,
                                   const rcsc::Vector2D & home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
