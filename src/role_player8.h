...
#ifndef GEAR_ROLE_PLAYER8_H
#define GEAR_ROLE_PLAYER8_H
...
public:
    ...
    ~RolePlayer8()
      {
          //std::cerr << "delete RolePlayer8" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "Player8" );
      }

    static
    SoccerRole * create()
      {
          return ( new RolePlayer8() );
      }
...
public:
    ...
    static rcsc::Vector2D p8AP;        //stores last position attack swarm
     
     static rcsc::Vector2D p8DP;        //stores last position defense swarm
     
     static rcsc::Vector2D p8VAP;       //stores last speed attack swarm
     
     static rcsc::Vector2D p8VDP;       //stores last speed defense swarm
     
     static rcsc::Vector2D p8PB;        //stores last personal best particle 8

     static rcsc::Vector2D p8PB5;       //stores last personal best particle 5
     
     static rcsc::Vector2D p8PB6;       //stores last personal best particle 6
     
     static rcsc::Vector2D p8PB7;       //stores last personal best particle 7
     
     static rcsc::Vector2D p8PB9;       //stores last personal best particle 9

     static rcsc::Vector2D p8PB10;       //stores last personal best particle 10
     
     static rcsc::Vector2D p8LB;        //stores last local best from the neighborhood                    
};
