...
#ifndef GEAR_ROLE_HCSIDE_FORWARD_H
#define GEAR_ROLE_HCSIDE_FORWARD_H
...
public:
    ...
    ~RoleHCSideForward()
      {
          //std::cerr << "delete RoleHCSideForward" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCSideForward" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCSideForward() );
      }
