...
int RoleHCCenterForward::S_count_shot_area_hold = 0;
...
*/
void
RoleHCCenterForward::execute( rcsc::PlayerAgent* agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCCenterForward::doKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleHCCenterForward::doMove( rcsc::PlayerAgent * agent )
{
...
*/
bool
RoleHCCenterForward::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleHCCenterForward::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCCenterForward::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleHCCenterForward::doShootAreaKick( rcsc::PlayerAgent* agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCCenterForward::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleHCCenterForward::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleHCCenterForward::doGoToPoint( rcsc::PlayerAgent * agent,
