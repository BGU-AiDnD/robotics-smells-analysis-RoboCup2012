...
#ifndef GEAR_ROLE_HCSIDE_HALF_H
#define GEAR_ROLE_HCSIDE_HALF_H
...
public:
    ...
    ~RoleHCSideHalf()
      {
          //std::cerr << "delete RoleHCSideHalf" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCSideHalf" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCSideHalf() );
      }
