...
*/
void
RoleHCSideHalf::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleHCSideHalf::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideHalf::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCSideHalf::doDribbleAttackKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideHalf::doShootChanceKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideHalf::doOffensiveMove( rcsc::PlayerAgent * agent,
...
*/
void
RoleHCSideHalf::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleHCSideHalf::doShootAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
bool
RoleHCSideHalf::doShootAreaIntercept( rcsc::PlayerAgent * agent,
                                         const rcsc::Vector2D & /*home_pos*/ )
{
    const rcsc::WorldModel & wm = agent->world();
    const int self_min = wm.interceptTable()->selfReachCycle();
...
int
RoleHCSideHalf::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
...
*/
void
RoleHCSideHalf::doShootAreaKick( rcsc::PlayerAgent* agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
bool
RoleHCSideHalf::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleHCSideHalf::doOffensiveMiddleKick( PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCSideHalf::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
...
*/
void
RoleHCSideHalf::doDribbleAttackAreaKick( rcsc::PlayerAgent* agent )
{
    // !!!check stamina!!!
    static bool S_recover_mode = false;
...
*/
bool
RoleHCSideHalf::doStraightDribble( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCSideHalf::doSideForwardDribble( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
rcsc::Vector2D
RoleHCSideHalf::getDribbleTarget( rcsc::PlayerAgent * agent )
{
...
*/
int
RoleHCSideHalf::getDribbleAttackDashStep( const rcsc::PlayerAgent * agent,
...
bool
RoleHCSideHalf::kickCentering( rcsc::PlayerAgent * agent )
{
  //センタリング 090704
  const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleHCSideHalf::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
