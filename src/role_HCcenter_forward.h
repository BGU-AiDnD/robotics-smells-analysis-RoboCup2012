...
#ifndef GEAR_ROLE_HCCENTER_FORWARD_H
#define GEAR_ROLE_HCCENTER_FORWARD_H
...
public:
    ...
    ~RoleHCCenterForward()
      {
          //std::cerr << "delete RoleHCCenterForward" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCCenterForward" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCCenterForward() );
      }
