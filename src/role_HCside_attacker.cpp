...
int RoleHCSideAttacker::S_count_shot_area_hold = 0;
/*-------------------------------------------------------------------*/
/*!

*/
void
RoleHCSideAttacker::execute( rcsc::PlayerAgent * agent )
{
...
void
RoleHCSideAttacker::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleHCSideAttacker::doMove( rcsc::PlayerAgent * agent )
{
...
int
RoleHCSideAttacker::countKickableCycleAtSamePoint(rcsc::PlayerAgent * agent){
  //double dash_power = 100.0;
...
bool
RoleHCSideAttacker::moveCentering( rcsc::PlayerAgent * agent )
{
  //double dash_power = 100.0;
  const rcsc::WorldModel & wm = agent->world();
...
*/
bool
RoleHCSideAttacker::doSelfPass( rcsc::PlayerAgent  * agent,
...
*/
void
RoleHCSideAttacker::doMiddleAreaKick( rcsc::PlayerAgent* agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCSideAttacker::doCrossAreaKick( rcsc::PlayerAgent* agent )
{
    //double dash_power = 100.0;
...
*/
void
RoleHCSideAttacker::doShootAreaKick( rcsc::PlayerAgent* agent )
{double dash_power = 100.0;
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleHCSideAttacker::doGoToCrossPoint( rcsc::PlayerAgent * agent,
...
*/
bool
RoleHCSideAttacker::doCheckCrossPoint( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
void RoleHCSideAttacker::doOffensiveMiddleKick( PlayerAgent * agent )
{double dash_power = 100.0;
    const rcsc::WorldModel & wm = agent->world();
...
void
RoleHCSideAttacker::doGoToPoint( PlayerAgent * agent,
