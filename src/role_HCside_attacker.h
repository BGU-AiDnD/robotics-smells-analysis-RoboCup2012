...
#ifndef GEAR_ROLE_HCSIDE_ATTACKER_H
#define GEAR_ROLE_HCSIDE_ATTACKER_H
...
public:
    ...
    ~RoleHCSideAttacker()
      {
          //std::cerr << "delete RoleHCSideAttacker" << std::endl;
      }
    ...
    std::string name()
      {
          return std::string( "HCSideAttacker" );
      }

    static
    SoccerRole * create()
      {
          return ( new RoleHCSideAttacker() );
      }
