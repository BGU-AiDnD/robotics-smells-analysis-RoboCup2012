...
*/
void
RoleLOffensiveHalf::execute( rcsc::PlayerAgent * agent )
{
    //////////////////////////////////////////////////////////////
    // play_on play
...
*/
void
RoleLOffensiveHalf::doKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLOffensiveHalf::doMove( rcsc::PlayerAgent * agent )
{
    const rcsc::WorldModel & wm = agent->world();
...
*/
void
RoleLOffensiveHalf::doDribbleAttackKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLOffensiveHalf::doShootChanceKick( rcsc::PlayerAgent * agent )
{
...
*/
void
RoleLOffensiveHalf::doOffensiveMove( rcsc::PlayerAgent * agent,
...
*/
void
RoleLOffensiveHalf::doDefensiveMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
void
RoleLOffensiveHalf::doShootAreaMove( rcsc::PlayerAgent * agent,
                                    const rcsc::Vector2D & home_pos )
{
...
*/
bool
RoleLOffensiveHalf::doShootAreaIntercept( rcsc::PlayerAgent * agent,
                                         const rcsc::Vector2D & /*home_pos*/ )
{
    const rcsc::WorldModel & wm = agent->world();
    const int self_min = wm.interceptTable()->selfReachCycle();
...
void
RoleLOffensiveHalf::doMiddleAreaKick( rcsc::PlayerAgent * agent )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLOffensiveHalf::doDribbleBlockMove( rcsc::PlayerAgent* agent,
                                       const rcsc::Vector2D& home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
...
*/
void
RoleLOffensiveHalf::doCrossBlockMove( rcsc::PlayerAgent* agent,
                                     const rcsc::Vector2D& home_pos )
{
    rcsc::dlog.addText( rcsc::Logger::ROLE,
