...
rcsc::Vector2D RolePlayer3::p3AP;

rcsc::Vector2D RolePlayer3::p3DP;

rcsc::Vector2D RolePlayer3::p3VAP;

rcsc::Vector2D RolePlayer3::p3VDP;

rcsc::Vector2D RolePlayer3::p3PB = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer3::p3PB2 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer3::p3PB4 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer3::p3PB5 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer3::p3PB6 = rcsc::Vector2D(-70.0,-70.0);

rcsc::Vector2D RolePlayer3::p3LB = rcsc::Vector2D(-70.0,-70.0);
...
*/
void
RolePlayer3::execute( PlayerAgent * agent )
{
...
*/
void
RolePlayer3::doKick( PlayerAgent * agent )
{
...
*/
void
RolePlayer3::doMove( PlayerAgent * agent )
{
    ...
    case Strategy::BA_ShootChance:
        ...
        {
            rcsc::Vector2D target_point = p3AP;
        ...
        {
            rcsc::Vector2D target_point = p3DP;
            double dash_power = Strategy::get_set_play_dash_power( wm );
            doGoToPoint( agent, target_point, dist_thr, dash_power, 15.0 );
            //rcsc::Body_GoToPoint(target_point, dist_thr, dash_power, true);
            //rcsc::Body_GoToPointDodge(target_point, dash_power);
...
*/
void
RolePlayer3::doBasicMove( PlayerAgent * agent,
...
*/
Vector2D
RolePlayer3::getBasicMoveTarget( PlayerAgent * agent,
                                    const Vector2D & home_pos,
                                    double * dist_thr )
{
    const WorldModel & wm = agent->world();
...
*/
void
RolePlayer3::doDefMidMove( PlayerAgent * agent,
                              const Vector2D & home_pos )
{
...
*/
Vector2D
RolePlayer3::getDefMidMoveTarget( PlayerAgent * agent,
                                     const Vector2D & home_pos )
{
    const WorldModel & wm = agent->world();
...
*/
void
RolePlayer3::doCrossBlockAreaMove( PlayerAgent * agent,
                                      const Vector2D & home_pos )
{
...
*/
void
RolePlayer3::doStopperMove( PlayerAgent * agent,
                               const Vector2D & home_pos )
{
...
*/
void
RolePlayer3::doDangerAreaMove( PlayerAgent * agent,
                                  const Vector2D & home_pos )
{
...
void
RolePlayer3::doMarkMove( PlayerAgent * agent,
                            const Vector2D & home_pos )
{
    //-----------------------------------------------
    // tackle
...
*/
bool
RolePlayer3::doDangerGetBall( PlayerAgent * agent,
                                 const Vector2D & home_pos )
{
    //////////////////////////////////////////////////////////////////
    // tackle
...
*/
void
RolePlayer3::doGoToPoint( PlayerAgent * agent,
...
//#if 0
void
RolePlayer3::swarmUpdatePosition(PlayerAgent * agent)
{    
    const WorldModel & wm = agent->world();
...
void
RolePlayer3::swarmAttack(PlayerAgent * agent)
{
    const WorldModel & wm = agent->world();
    ...
    {
        if(wm.teammate(2) != 0) p3PB2 = wm.teammate(2)->pos();

        if(wm.teammate(3) != 0) p3PB = wm.teammate(3)->pos();

        if(wm.teammate(4) != 0) p3PB4 = wm.teammate(4)->pos();

        if(wm.teammate(5) != 0) p3PB5 = wm.teammate(5)->pos();

        if(wm.teammate(6) != 0) p3PB6 = wm.teammate(6)->pos();

        if(wm.teammate(6) != 0) p3LB = wm.teammate(6)->pos();

        p3VAP.x = wm.ball().pos().x - wm.self().pos().x;
        p3VDP.x = wm.ball().pos().x - wm.self().pos().x;

        p3AP = rcsc::Vector2D(-50.0,0.0);
        p3DP = rcsc::Vector2D(-50.0,0.0);
    ...
    else
    {
        ...
        if(p3PB2 != PB[0]) p3PB2 = PB[0];

        if (p3PB != PB[1]) p3PB = PB[1];

        if (p3PB4 != PB[2]) p3PB4 = PB[2];

        if (p3PB5 != PB[3]) p3PB5 = PB[3];

        if (p3PB6 != PB[4]) p3PB6 = PB[4];
        ...
        p3AP = wm.self().pos() + speed;
        p3DP = wm.self().pos() + speed;

        p3VAP = p3AP;       //represents inertia
        p3VDP = p3DP;
    }
}
/*
...
void
RolePlayer3::swarmDefense(PlayerAgent * agent)
{
    Swarm s;
}
//#endif
